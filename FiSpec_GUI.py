...
class FiSpec_GUI:
    def __init__(self, master):
        ...
        self.frame_setCh.place(x=5,y=200, width=495, height=45)
        ...
        self.frame_setAv.place(x=5,y=250, width=495, height=45)

        self.setAv_In = Entry(self.frame_setAv, width=20)
        self.setAv_In.place(x=15, y=2)
        self.setAv_In.insert(0, "2000")
        ...
        self.frame_setZe.place(x=5,y=300, width=495, height=45)
        ...
        self.frame_autoO.place(x=5,y=350, width=495, height=45)

        self.setAO_In = Entry(self.frame_autoO, width=20)
        self.setAO_In.place(x=15, y=2)
        self.setAO_In.insert(0, "0")
